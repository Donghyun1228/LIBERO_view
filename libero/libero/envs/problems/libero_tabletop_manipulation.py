...
@register_problem
class Libero_Tabletop_Manipulation_Texture(Libero_Tabletop_Manipulation):
    ...
    def __init__(self, bddl_file_name, *args, **kwargs):
        ...
        if "scene_xml" not in kwargs or kwargs["scene_xml"] is None:
            kwargs.update({"scene_xml": "scenes/libero_tabletop_texture_style.xml"})
        if "scene_properties" not in kwargs or kwargs["scene_properties"] is None:
            kwargs.update(
                {
                    "scene_properties": {
...
@register_problem
class Libero_Tabletop_Manipulation_Light_Texture(Libero_Tabletop_Manipulation):
    ...
    def __init__(self, bddl_file_name, *args, **kwargs):
        ...
        if "scene_xml" not in kwargs or kwargs["scene_xml"] is None:
            kwargs.update({"scene_xml": "scenes/libero_tabletop_light_texture_style.xml"})
        if "scene_properties" not in kwargs or kwargs["scene_properties"] is None:
            kwargs.update(
                {
                    "scene_properties": {
