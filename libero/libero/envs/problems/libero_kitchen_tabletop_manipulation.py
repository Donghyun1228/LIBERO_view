...
class Libero_Kitchen_Tabletop_Manipulation(BDDLBaseDomain):
    ...
    def _setup_camera(self, mujoco_arena):
        ...
        setup_camera_views(mujoco_arena, env="kitchen")

@register_problem
class Libero_Kitchen_Tabletop_Manipulation_Light(Libero_Kitchen_Tabletop_Manipulation):
    ...
    def __init__(self, bddl_file_name, *args, **kwargs):
        ...
        if "scene_xml" not in kwargs or kwargs["scene_xml"] is None:
            kwargs.update(
                {"scene_xml": "scenes/libero_kitchen_tabletop_light_style.xml"}
            )
        if "scene_properties" not in kwargs or kwargs["scene_properties"] is None:
            kwargs.update(
                {
...
@register_problem
class Libero_Kitchen_Tabletop_Manipulation_Texture(Libero_Kitchen_Tabletop_Manipulation):
    ...
    def __init__(self, bddl_file_name, *args, **kwargs):
        ...
        if "scene_xml" not in kwargs or kwargs["scene_xml"] is None:
            kwargs.update(
                {"scene_xml": "scenes/libero_kitchen_tabletop_texture_style.xml"}
            )
        if "scene_properties" not in kwargs or kwargs["scene_properties"] is None:
            kwargs.update(
                {
...
@register_problem
class Libero_Kitchen_Tabletop_Manipulation_Light_Texture(Libero_Kitchen_Tabletop_Manipulation):
    ...
    def __init__(self, bddl_file_name, *args, **kwargs):
        ...
        if "scene_xml" not in kwargs or kwargs["scene_xml"] is None:
            kwargs.update(
                {"scene_xml": "scenes/libero_kitchen_tabletop_light_texture_style.xml"}
            )
        if "scene_properties" not in kwargs or kwargs["scene_properties"] is None:
            kwargs.update(
                {
