...
class OnTheGroundPanda1(ManipulatorModel):
    """
    Panda variant with significantly different initial joint configuration.
    Args:
        idn (int or str): Number or some other unique identification string for this robot instance
    """
    ...
    @property
    def init_qpos(self):
        # Same as OnTheGroundPanda but with first joint rotated by 30 degrees
        return np.array(
            [
                0.524,
                -1.61037389e-01,
